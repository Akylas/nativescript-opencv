...
import { findDocuments, persp_transform } from '~/contours';
    ...
    processImage(nativeDatas: { [k: string]: any }, data) {
        ...
        try {
            ...
            if (full) {
                ...
                (org.nativescript as any).demovueopencv.WorkersContext.setValue(`${id}_edgesImage`, result.edgesImage.clone());
                (org.nativescript as any).demovueopencv.WorkersContext.setValue(`${id}_images`, nativeArray(images));
